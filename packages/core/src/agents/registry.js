...
import { DEFAULT_GEMINI_MODEL, GEMINI_MODEL_ALIAS_AUTO, PREVIEW_GEMINI_FLASH_MODEL, isPreviewModel, isAutoModel, } from '../config/models.js';
...
export class AgentRegistry {
    ...
    async loadAgents() {
        ...
        if (!folderTrustEnabled || isTrustedFolder) {
            ...
            await Promise.allSettled(projectAgents.agents.map((agent) => this.registerAgent(agent)));
        }
        else {
