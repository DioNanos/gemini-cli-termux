...
export async function loadCliConfig(settings, sessionId, argv, options = {}) {
    ...
    if (argv.approvalMode) {
        ...
        switch (argv.approvalMode) {
            ...
            case 'default':
                ...
                break;
            default:
                throw new Error(`Invalid approval mode: ${argv.approvalMode}. Valid values are: yolo, auto_edit, plan, default`);
        }
    }
    else {
    ...
    return new Config({
        ...
        skillsSupport: settings.experimental?.skills || (settings.skills?.enabled ?? true),
        ...
        enableHooks: (settings.tools?.enableHooks ?? true) &&
