    ...
    notifications: {
        ...
        properties: {
            ttsEnabled: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Allow the CLI to run termux-tts-speak for job summaries. Disable to block TTS commands.',
                showInDialog: true,
            },
        },
    },
        ...
        `,
                ...
                properties: {
                    ...
                    allowBaseWrite: {
                        ...
                        requiresRestart: false,
                        default: false,
                        description: 'Permit writing to base.json when explicitly requested. Keeps read-only by default.',
                        showInDialog: false,
                    },
                    primary: {
                        type: 'enum',
                        ...
                        description: 'Memory source to load first (ordering then falls back to the others).',
                        showInDialog: false,
                    },
                    autoLoad: {
                        type: 'object',
                        ...
                        requiresRestart: false,
                        default: {},
                        description: 'Select which memory sources load automatically at session start.',
                        showInDialog: false,
                        properties: {
                            gemini: {
                                type: 'boolean',
                                ...
                                requiresRestart: false,
                                default: true,
                                description: 'Load GEMINI.md (primary file list) when starting a session.',
                                showInDialog: false,
                            },
                            jsonBase: {
                                type: 'boolean',
                    ...
                    paths: {
                        ...
                        requiresRestart: false,
                        default: {},
                        description: 'Filesystem locations for context memory files. Change manually if needed.',
                        showInDialog: false,
                        properties: {
                            base: {
                                type: 'string',
    ...
    memory: {
        ...
        properties: {
            mode: {
                ...
                description: 'Select how GEMINI.md, JIT, and JSON context memory sources are combined.',
                showInDialog: true,
            },
            contextMemory: {
                type: 'object',
        ...
        `,
                ...
                properties: {
                    enabled: {
                        ...
                        requiresRestart: false,
                        default: true,
                        description: 'Toggle JSON context memory (base/user/journal). Memory Mode can override this.',
                        showInDialog: true,
                    },
                    allowBaseWrite: {
                        type: 'boolean',
